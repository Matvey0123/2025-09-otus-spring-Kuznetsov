...
public class BookServiceImpl implements BookService {
    ...
    public BookDto insert(BookCreateDto dto) {
        var authorId = dto.getAuthor().getId();
        var genreIds = getGenresIdsFromDto(dto.getGenres());
    ...
    public BookDto update(BookUpdateDto dto) {
        ...
        var authorId = dto.getAuthor().getId();
        var genresIds = getGenresIdsFromDto(dto.getGenres());
    ...
    private Set<Long> getGenresIdsFromDto(List<GenreDto> genres) {
